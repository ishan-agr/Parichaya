...
export default class Camera extends Component {
    ...
    startcamera() {
        const CAPTURE_OPTIONS = {
            audio: false,
            video: {
                facingMode: this.state.toggle === true ? 'user' : 'environment',
                width: {
                    min: 640,
                    max: 1920
                },
                ...
                return (
                    <div>
                        <div style={{ borderStyle: "solid", borderColor: "#a4a4a4", marginTop: "10px", marginLeft: "10px", marginRight: "10px", marginBottom: "20px" }}>
                            ...
                            <h5 style={{ marginTop: "20px", marginLeft: "10px", marginRight: "10px", paddingLeft: "10px", paddingRight: "10px", }}>We need to access the camera to complete your KYC process</h5>
